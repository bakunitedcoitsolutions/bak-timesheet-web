...
const reportOptions: ReportOption[] = [
  {
    ...
    icon: "fa-light fa-file-invoice text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-file-contract text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-receipt text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-calendar-circle-plus text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-calendar-check text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-user-group text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-file-chart-pie text-xl!",
