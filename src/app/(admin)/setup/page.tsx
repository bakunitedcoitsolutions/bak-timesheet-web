...
const setupOptions: SetupOption[] = [
  {
    ...
    icon: "fa-light fa-globe text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-sitemap text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-building-memo text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-briefcase text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-user-check text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-wallet text-xl!",
  ...
  },
  {
    ...
    icon: "fa-light fa-user-shield text-xl!",
